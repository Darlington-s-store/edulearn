      ...
      <div className="relative max-w-2xl w-full">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-800 font-playful mb-2">Student Sign Up</h1>
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-gray-600">
              ...
              <Link to="/login/student" className="text-blue-600 hover:text-blue-700 font-medium">
                Sign in here
              </Link>
            </p>
            <div className="flex items-center justify-center gap-4 text-sm text-gray-500">
              ...
              <span>•</span>
              <Link to="/signup/teacher" className="hover:text-gray-700">Sign up as Teacher</Link>
            </div>
          </div>
        </div>
      </div>
