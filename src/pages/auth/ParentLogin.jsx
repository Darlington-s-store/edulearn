...
function ParentLogin() {
  ...
  const handleBiometricSuccess = async (data) => {
    ...
    const testCredentials = { email: 'parent@example.com', password: 'password123' };
    const result = await login(testCredentials.email, testCredentials.password, 'parent');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-green-100 flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-green-200 to-emerald-200 rounded-full opacity-30 animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-emerald-200 to-green-300 rounded-full opacity-30 animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <Users className="w-64 h-64 text-green-200 opacity-10 animate-float" />
        </div>
      </div>
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            <div className="relative inline-block">
              <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-emerald-500 rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg animate-float">
            ...
            <h1 className="text-4xl font-bold text-gray-800 font-playful mb-2">Parent Login</h1>
            <p className="text-gray-600">Monitor and support your child's learning journey</p>
          </div>

          {/* Parent Benefits Banner */}
          <div className="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-4 border border-green-200">
            <div className="flex items-center gap-3 mb-2">
              <Shield className="w-5 h-5 text-green-600" />
              <span className="font-semibold text-green-800">Parent Benefits</span>
            </div>
          ...
          {loginMethod === 'traditional' ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white text-lg py-4 rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
              >
                {loading ? (
                  <>
              ...
              {loginMethod === 'face' && (
                <div className="text-center space-y-4">
                  ...
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white text-lg py-4 rounded-xl font-semibold hover:from-green-700 hover:to-emerald-700 transition-all flex items-center justify-center gap-2 shadow-lg"
                  >
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-gray-600">
              ...
              <Link to="/signup/parent" className="text-green-600 hover:text-green-700 font-medium">
                Sign up as Parent
              </Link>
            </p>
            <div className="flex items-center justify-center gap-4 text-sm text-gray-500">
              <Link to="/login/student" className="hover:text-gray-700">Student Login</Link>
              <span>•</span>
